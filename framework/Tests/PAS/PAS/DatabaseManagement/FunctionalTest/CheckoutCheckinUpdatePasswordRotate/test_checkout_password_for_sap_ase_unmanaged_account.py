...
@pytest.mark.pasapi
@pytest.mark.bhavna
def test_checkout_password_for_sap_ase_unmanaged_account(core_session, add_database_with_account):
    """
    Test case: C1103 - Checkout password for a SAP ASE unmanaged account
