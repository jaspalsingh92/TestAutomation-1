...
from Shared.UI.Centrify.selectors import Modal, ConfirmModal, Div
...
def test_ui_check_bulk_delete_account_confirm(core_session, core_admin_ui, list_of_created_systems):
    """
         Test case: C3087
    ...
    ui.expect(Div("You are about to delete accounts which contain passwords or SSH Keys. This cannot be undone. Are "
