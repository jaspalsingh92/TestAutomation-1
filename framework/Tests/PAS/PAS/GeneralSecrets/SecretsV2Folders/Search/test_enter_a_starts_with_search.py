...
@pytest.mark.bhavna
def test_enter_a_starts_with_search(core_session,
                                    pas_general_secrets,
                                    cleanup_secrets_and_folders,
                                    core_admin_ui):
    """
        C3060: Enter a starts with search
    ...
    assert permissions["Result"], \
        f'Failed to verify permissions for the folder, API response result:{permissions["Result"]}'
